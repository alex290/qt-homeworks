...
MainWindow::MainWindow(QWidget* parent) : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    chartWin = new ChartWin(this);
    connect(this, &MainWindow::show_chart, this, &MainWindow::ShowDataChart, Qt::ConnectionType::QueuedConnection);
}
...
void MainWindow::ShowDataChart(QVector<double>& res)
{
    chartWin->show();
    chartWin->ShGraph(res);
}
